	<h3 class="modal-title"><?php echo empty($page->id) ? "Add A New Page" : "Edit page " . $page->title; ?></h3>
...
<table class="table">
	...
	<tr>
		<td>Template</td>
		<td><?php echo form_dropdown('template', array('page'=> 'page','homepage'=>'Homepage'), $this->input->post('template') ? $this->input->post('template') : $page->parent_id); ?></td>
	</tr>
